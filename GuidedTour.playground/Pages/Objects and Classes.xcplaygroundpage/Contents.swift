...
class Shape {
    var numberOfSides = 0
    let anotherProperty = 0
    
    func simpleDescription() -> String {
        return "A shape with \(numberOfSides) sides."
    }
    
    func anotherMethod(anotherName: String, secondParam: String) -> String {
        return "This is another return," + anotherName + secondParam
    }
}
...
var anotheroutput = shape.anotherMethod("Hi", secondParam: "Carson")
